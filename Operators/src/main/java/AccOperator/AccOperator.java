...
//            }
//        }).print();
        SingleOutputStreamOperator<Row> returns = ds2
                ...
                ).slotSharingGroup("default").returns(Types.ROW_NAMED(new String[]{"institution_short", "inst_count", "inst_sum"}, Types.STRING, Types.LONG, Types.LONG)).setParallelism(1);
        returns.print();
        env.execute();
